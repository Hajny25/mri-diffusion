...
gnetwork  = torch.nn.parallel.DistributedDataParallel(
        autoencoder.to(device), device_ids=[local_rank], output_device=local_rank
)
dnetwork = torch.nn.parallel.DistributedDataParallel(
        discriminator.to(device), device_ids=[local_rank], output_device=local_rank
    )
